...
import 'package:rashail_multi_dropdown/models/network_config.dart';
import 'package:rashail_multi_dropdown/widgets/hint_text.dart';
import 'package:rashail_multi_dropdown/widgets/selection_chip.dart';
import 'package:rashail_multi_dropdown/widgets/single_selected_item.dart';
...
class RashailMultiDropdown extends StatefulWidget {
  ...
  /// RashailMultiDropdown is a widget that allows the user to select multiple options from a list of options. It is a dropdown that allows the user to select multiple options.
  ///
  ///  **Selection Type**
  ///
  ...
  /// Constructor for RashailMultiDropdown that fetches the options from a network call.
  ...
  const RashailMultiDropdown.network({
    Key? key,
  ...
  @override
  State<RashailMultiDropdown> createState() => _RashailMultiDropdownState();
}

class _RashailMultiDropdownState extends State<RashailMultiDropdown> {
  ...
  @override
  void didUpdateWidget(covariant RashailMultiDropdown oldWidget) {
